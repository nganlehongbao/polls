...
export default function Header({ title }) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/dashboard', current: title === 'Dashboard'},
    { name: 'Leadership', href: '/leadership', current: title === 'Leadership' },
    { name: 'New', href: '/new', current: title === 'New' },
  ]
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'bg-slate-200 text-slate-900' : 'text-slate-600 hover:bg-slate-200 hover:text-slate-900',
